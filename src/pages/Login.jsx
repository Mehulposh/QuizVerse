...
export default function Login() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col">
      <div className="relative mx-auto flex w-full max-w-md flex-1 flex-col items-center justify-center p-6">
        <div
        ...
        <div className="glass-strong animate-pop-in relative z-10 w-full rounded-3xl p-8">
          ...
          <div className="glass-inset flex rounded-xl p-1 text-sm font-medium mt-3">
            <button
